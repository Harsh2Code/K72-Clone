...
function Navbar() {
    ...
    return (
        <div className='z-4 flex fixed top-0 w-screen items-between justify-between cursor-pointer relative'>
            ...
            <div onClick={() => {
                ...
                bgChange.current.style.backgroundColor = 'black';
                bgChange2.current.style.backgroundColor = 'black';
            }
            }
                onMouseLeave={
                    () => {
                        navGreenRef.current.style.top = '-100vh';
                        bgChange.current.style.backgroundColor = 'white';
                        bgChange2.current.style.backgroundColor = 'white';
                    }
                }
